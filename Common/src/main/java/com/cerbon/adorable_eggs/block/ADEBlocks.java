...
public class ADEBlocks {
    ...
    public static final RegistryEntry<EggBlock> PIG_EGG = register("pig_egg_egg", Items.PIG_SPAWN_EGG, MapColor.COLOR_PINK);
    ...
    public static final RegistryEntry<EggBlock> SNIFFER_EGG = register("sniffer_egg", Items.SNIFFER_EGG, MapColor.COLOR_RED);
    ...
    public static final RegistryEntry<EggBlock> TURTLE_EGG = register("turtle_egg", Items.TURTLE_EGG, MapColor.COLOR_GREEN);
